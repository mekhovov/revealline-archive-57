#!/usr/bin/env python3
"""Configure dedicated archive-57 inventory from v0.88.0's original metadata."""
import hashlib
import json
...
VERSION = "v0.88.0"
SOURCE = "950f19045facacf5151c90661de1ca28d30658df"
TREE = "0c288a694a4c2cba04a7ae331eb3a376bdd4c811"
TAG = "df3e545f03432486a7eee321fb0799fb7490a1cb"
ZIP = "8d7cc857a2eb2d31432b27220d31b6a1ed33990fb6158de1e8c3fdf5d756706f"
ZIP_BYTES = 591074583
...
def main():
    ...
    assert qualification.stat().st_size == 14001 and sha(qualification.read_bytes()) == "79ac76e512b4c5a7652014af33ba73a403b6253b00993f051862f0cf3ea4720e"
    ...
    lock = {
        "format": "revealline-archive-originals.v2", "archiveId": "archive-57", "repository": "mekhovov/revealline-archive-57",
    ...
    inventory = {"base": "https://mekhovov.github.io/revealline-archive-57/", "files": rows}
    ...
    assert original["id"] == 394233790 and original["tag_name"] == VERSION
    ...
    (ROOT / "input-authority.json").write_bytes(json_bytes({
        "version": VERSION, "releaseId": 394233790, "source": SOURCE, "tree": TREE, "tagObject": TAG,
        "donorCommit": "592d0afe42f66dfb9fe95962c80adfaf236cd8ef", "toolingCommit": TOOLING, "donorDeploymentMerge": "592d0afe42f66dfb9fe95962c80adfaf236cd8ef", "priorAcceptedPaths": 0,
